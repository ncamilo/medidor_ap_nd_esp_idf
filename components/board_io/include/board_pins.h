...
// =========================
// Balanca serial
// Equipamento opera como transmissor; TX pode permanecer desconectado.
// =========================
...
// =========================
// DIP switches
// Baseline: chave para GND com pull-up interno, ativa em nivel baixo.
// Validar funcoes/polaridade no hardware real.
// =========================
